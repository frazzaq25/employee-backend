...
const { registerEmployee, login, logout, getMyProfile, clockIn, startBreak, stopBreak, clockOut, getAllEmployees, updateEmployee, deleteEmployee, getEmployeeDetails, getUpcomingBirthdays, updateProfilePicture, changePassword, forgetPassword, resetPassword } = require('../controllers/employee');
